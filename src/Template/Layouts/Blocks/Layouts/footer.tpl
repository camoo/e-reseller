            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul>
                            <li><a href="/packages">Hosting</a></li>
                            <li><a href="/">Domain</a></li>
                            <li><a href="/packages#wordpress">Wordpress</a></li>
                            <li><a href="/packages#shared-hosting">Shared Hosting</a></li>
                        </ul>
                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="footer_widget">
                        ...
                        <p class="newsletter_text">Abonnez-vous à notre newsletter pour ne pas rater nos dernières
                            publications</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <p class="copy_right text-center">
                        <span>&copy; Copyright {{ "now"|date('Y', "Africa/Douala") }} by {{ siteConfig.company_name }}. <a
                                class="right" href="https://colorlib.com" target="_blank">Colorlib</a></span>
                    </p>
                </div>
            </div>
        </div>
...
{% if is_loggedin() and basket.count() > 0 and siteConfig.can_mobile_money %}
<section id="momo-form" class="white-popup-block mfp-hide">
    <div class="popup_box ">
        <div class="popup_inner">
            <div class="logo text-center">
                <a href="#">
                    <img src="/img/momo.png" alt="Mobile money payment">
                </a>
            </div>
            <h3>Payer par Mobile Money</h3>
            {{ form_start('momo', {'url':'#', 'class' : 'online-payment'})}}
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    {{ form_input('phoneNumber', {'type': 'number', 'placeholder' : 'Votre numéro de téléphone', 'required' : 'required'}) }}
                </div>

                <div class="col-xl-12">
                    {{ form_input('submit', {'id':'apply-momo','type' : 'submit', 'class' : 'boxed_btn_green', 'value' : 'Payer'}) }}
                </div>
            </div>
            {{ form_end() }}
        </div>
